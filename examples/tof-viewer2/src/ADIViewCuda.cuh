...
void processDepthImage_CUDA(
    uint16_t* d_depthBuffer,
    uint16_t* h_depthBuffer,
    uint8_t* d_bgrBuffer,
    uint8_t* h_bgrBuffer,
    int width,
    int height,
...
void processPointCloud_CUDA(
    int16_t* d_xyzBuffer,
    int16_t* h_xyzBuffer,
    float* d_vertexBuffer,
    float* h_vertexBuffer,
    uint8_t* d_abBuffer,
    int width,
    int height,
    float maxX,
