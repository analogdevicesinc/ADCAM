...
v4l2-ctl --set-ctrl=operating_mode=7 -d $SUBDEV_PATH
...
v4l2-ctl --device $VIDEO_PATH --set-fmt-video=width=1024,height=2880,pixelformat=RG12 --stream-mmap --stream-to=raw_mode7.bin --stream-count=$nr_frames
