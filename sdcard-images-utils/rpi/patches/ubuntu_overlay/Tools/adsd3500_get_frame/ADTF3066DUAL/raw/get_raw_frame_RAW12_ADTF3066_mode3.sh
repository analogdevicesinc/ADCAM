...
v4l2-ctl --set-ctrl=operating_mode=3 -d $SUBDEV_PATH
...
v4l2-ctl --device $VIDEO_PATH --set-fmt-video=width=512,height=1440,pixelformat=RG12 --stream-mmap --stream-to=raw_mode3.bin --stream-count=$nr_frames
