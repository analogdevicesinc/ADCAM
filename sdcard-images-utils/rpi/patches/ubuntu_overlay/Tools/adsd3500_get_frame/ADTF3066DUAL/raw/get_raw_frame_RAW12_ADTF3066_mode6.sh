...
v4l2-ctl --set-ctrl=operating_mode=6 -d $SUBDEV_PATH
...
v4l2-ctl --device $VIDEO_PATH --set-fmt-video=width=512,height=960,pixelformat=RG12 --stream-mmap --stream-to=raw_mode6.bin --stream-count=$nr_frames
