1) Firmware_update executable will be available at this path and it takes three argument.
	...
	Usage: sudo ./firmware_update <bin|stream file> <master|slave>
	...
	$ sudo ./firmware_update Fw_Update_x.x.x.bin master
	$ sudo ./firmware_update ADSD3500_Second_Firmware_Host_Boot_X_X_X.stream slave
