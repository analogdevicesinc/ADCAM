...
run_interrupt_sequence_config3() {
    # TODO: interrupt sequence for ADSD3500/ADTF3066 + RGB is not yet defined.
    echo "Interrupt sequence for CONFIG 3 (ADSD3500/ADTF3066 + RGB) is not yet implemented. Skipping."
}
...
main() {
    ...
    case "$CONFIG" in
        0)
            echo "Skipping interrupt enable: no matching module badge combination found"
            exit 0
            ;;
        1|2)
